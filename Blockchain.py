...
class Blockchain(object):
    ...
    def hash(block):
        ...
        h = hashlib.sha256(block_string).hexdigest().upper()
        # print(h)
        #Encrypting the SHA-256 into DES and then concatinating
        des.pt = h[0:16]
        s = des.cipher_text
    ...
    The goal of PoW is to discover a number which solves the problem.
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            print(f'{block}')
            print("\n-----------\n")
            # Check whether the hash of the block is correct or not
            blk = block['previous hash'].upper()
